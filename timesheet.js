...
function Monday() {
    document.getElementById("change__monday").innerHTML = "Monday, 18 july"
    document.getElementById("hide__text").style.display = "none"
}

function Tuesday() {
    document.getElementById("change__monday").innerHTML = "Tuesday, 19 july"
    document.getElementById("hide__text").style.display = "none"
}

function Wednesday() {
    document.getElementById("change__monday").innerHTML = "wednesday, 20 july "
    document.getElementById("hide__text").innerHTML = "none"
}

function Thursday() {
    document.getElementById("change__monday").innerHTML = "Thursday, 21 july"
    document.getElementById("hide__text").innerHTML = "none"
}

function Friday() {
    document.getElementById("change__monday").innerHTML = "Friday, 22 july"
    document.getElementById("hide__text").innerHTML = "none"
}

function Saturday() {
    document.getElementById("change__monday").innerHTML = "Today: Saturday, 23 july"
    document.getElementById("hide__text").innerHTML = "none"
}

function Sunday() {
    document.getElementById("change__monday").innerHTML = "Sunday, 24 july"
    document.getElementById("hide__text").innerHTML = "none"
}
